...
export const THEMES = {
  night: {
    ...
    ringBright: 'rgba(90, 130, 220, 0.62)',
    ringText: 'rgba(150, 180, 255, 0.7)',
    ringTextBright: 'rgba(150, 180, 255, 0.94)',
  ...
  amber: {
    ...
    ringBright: 'rgba(255, 176, 64, 0.62)',
    ringText: 'rgba(255, 200, 120, 0.7)',
    ringTextBright: 'rgba(255, 200, 120, 0.94)',
  ...
  green: {
    ...
    ringBright: 'rgba(64, 230, 130, 0.58)',
    ringText: 'rgba(120, 255, 170, 0.7)',
    ringTextBright: 'rgba(120, 255, 170, 0.94)',
